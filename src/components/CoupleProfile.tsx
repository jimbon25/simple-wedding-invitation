  ...
  return (
    <SectionCard>
      <StoryItem>
        ...
        {/* Judul mempelai dan icon dihilangkan sesuai permintaan user */}
      </StoryItem>
      <div
        style={{
          textAlign: "center",
        ...
        >
          ...
          >
            ...
            <a
              ...
              className="btn btn-outline-secondary btn-sm mt-1 instagram-btn-custom"
            >
              <span
      ...
      <style>{`
        .section-card {
          ...
          border-radius: 18px;
          border: 1.5px solid rgba(154, 175, 136, 0.22);
          box-shadow: 0 2px 16px rgba(154,175,136,0.10);
